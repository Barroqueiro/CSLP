 ...
 *	Eighth Flag -> Quantization of the error
 *	Ninth Flag -> File to encode to
 *
 *	Press ESC to exit.
 *
 */
...
{	
	...
	//for (int  m:m_values){
		...
		//}
	//}
	LosslessHybrid l(argv[1],stoi(argv[2]),stoi(argv[3]),stoi(argv[4]),stoi(argv[5]),stoi(argv[6]),stoi(argv[7]),1,argv[9],stoi(argv[8]));
	l.encode();
	return 0;
}
